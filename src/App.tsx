...
function LeadsView({ isMobile, openNewNonce = 0 }: { isMobile:boolean;openNewNonce?:number }) {
  ...
  const [error,setError]=useState(""),[creating,setCreating]=useState(false),[copyNotice,setCopyNotice]=useState("");
